...
public class GUICategories extends javax.swing.JFrame {
     ...
     */
    public GUICategories(java.awt.Frame parent, boolean modal,CategoryService categoryService) {
        //super(parent, modal);
        initComponents();
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        if (txtName.getText().trim().equals("")) {
            Messages.showMessageDialog("Debe ingresar el nombre dela categoria", "Atención");
            txtName.requestFocus();
            return;
        }
        if (addOption) {
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        if (id.equals("")) {
            Messages.showMessageDialog("Debe ingresar la categoria a eliminar", "Atención");
            txtId.requestFocus();
            return;
        }
        Long categoryId = Long.parseLong(id);
        if (Messages.showConfirmDialog("Está seguro que desea eliminar este categoria?", "Confirmación") == JOptionPane.YES_NO_OPTION) {
            if (categoryService.deleteCategory(categoryId)) {
                Messages.showMessageDialog("Categoria eliminado con éxito", "Atención");
                stateInitial();
                cleanControls();
            }
        }
    ...
    private void txtNameFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtNameFocusLost
        ...
        if (category == null) {
            Messages.showMessageDialog("El nombre  de la categoria no existe", "Error");
            txtName.setText("");
            txtName.requestFocus();
        } else {
            txtId.setText(category.getCategoryId().toString());
    ...
    private void editCategory() {
        ...
        if (name.equals("")) {
            Messages.showMessageDialog("La categoria debe tener un nombre", "Atención");
            txtName.requestFocus();
            return;
        }
