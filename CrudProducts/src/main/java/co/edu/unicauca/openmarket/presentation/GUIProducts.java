 ...
 */
public class GUIProducts extends javax.swing.JFrame  implements  IObserver{
    ...
    private void initComponents() {
        ...
        btnCategoriesGestion = new javax.swing.JButton();
        ...
        jLabel1.setText("*Id:");
        pnlCenter.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 20, 30, 60));
        ...
        pnlCenter.add(txtId, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 30, 230, 30));

        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel2.setText("*Nombre:");
        pnlCenter.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 90, -1, 20));
        pnlCenter.add(txtName, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 80, 230, 30));

        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel3.setText("Descripción:");
        pnlCenter.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 170, 70, 20));

        txtDescription.setColumns(20);
        txtDescription.setRows(5);
        jScrollPane1.setViewportView(txtDescription);

        pnlCenter.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 140, 295, 82));

        jLabel4.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel4.setText("Categoria:");
        pnlCenter.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 30, 70, 20));

        cbxCategories.setName(""); // NOI18N
        pnlCenter.add(cbxCategories, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 30, 150, -1));

        btnCategoriesGestion.setText("Gestionar Categorias");
        btnCategoriesGestion.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnCategoriesGestionActionPerformed(evt);
            }
        });
        pnlCenter.add(btnCategoriesGestion, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 70, -1, -1));
    ...
    private void btnCategoriesGestionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCategoriesGestionActionPerformed
        GUICategories instance = new GUICategories(this, true, categoryService);
        instance.setVisible(true);
        
    }//GEN-LAST:event_btnCategoriesGestionActionPerformed
    ...
    private javax.swing.JButton btnCategoriesGestion;
    ...
    private void addProduct() {
        if(cbxCategories.getItemCount() == 0){
            Messages.showMessageDialog("Debe adicionar una categoria", "Atención");
            GUICategories instance = new GUICategories(this, true, categoryService);
            instance.setVisible(true);
            return;
        }
    ...
    private void editProduct() {
        ...
        String categoryName = cbxCategories.getSelectedItem().toString();
        category.setCategoryId(categoryService.findCategoryByName(categoryName).getCategoryId());
